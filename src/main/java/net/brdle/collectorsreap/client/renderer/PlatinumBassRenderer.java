...
public class PlatinumBassRenderer extends MobRenderer<PlatinumBass, PlatinumBassModel> {
	...
	@Override
	protected void setupRotations(@NotNull PlatinumBass entityLiving, @NotNull PoseStack stack, float pAgeInTicks, float pRotationYaw, float pPartialTicks, float pBodyRot) {
