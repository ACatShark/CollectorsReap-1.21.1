...
public class TigerPrawnRenderer extends MobRenderer<TigerPrawn, TigerPrawnModel> {
	...
	@Override
	protected void setupRotations(@NotNull TigerPrawn entityLiving, @NotNull PoseStack stack, float pAgeInTicks, float pRotationYaw, float pPartialTicks, float pBodyRot) {
