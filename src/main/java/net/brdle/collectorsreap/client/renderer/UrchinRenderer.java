...
public class UrchinRenderer extends MobRenderer<Urchin, UrchinModel> {
	...
	@Override
	protected void setupRotations(@NotNull Urchin entityLiving, @NotNull PoseStack stack, float pAgeInTicks, float pRotationYaw, float pPartialTicks, float pBodyRot) {
