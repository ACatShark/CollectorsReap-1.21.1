...
public class ChieftainCrabRenderer extends MobRenderer<ChieftainCrab, ChieftainCrabModel> {
	...
	@Override
	protected void setupRotations(@NotNull ChieftainCrab entityLiving, @NotNull PoseStack stack, float pAgeInTicks, float pRotationYaw, float pPartialTicks, float pBodyRot) {
